...
public class RoyalCommands extends JavaPlugin {
    ...
    ConfigUtil configU;
    public YamlConfiguration ipConf;

    public RoyalCommands() {
        pconfm = new PConfManager(this);
        configU = new ConfigUtil(this);
    }
    ...
    public void onEnable() {
        ...
        ConfigUtil.loadConfig("ip");
        ipConf = ConfigUtil.getConfig("ip");
        ...
        registerCommand(new CmdRemove(this), "rm", this);
